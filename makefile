all:
	...
	mkdir -p bin
	javac -Xlint:deprecation -source 1.8 -target 1.8 -d bin/ -sourcepath src/ -classpath bin/ src/Graphwar/*.java src/GraphServer/*.java src/GlobalServer/*.java src/RoomServer/*.java
